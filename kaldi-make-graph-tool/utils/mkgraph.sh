...
if $add_sp;
then
	grep sp $lang/phones.txt|awk '{print $2}' > $lang/phones/sp.int
	cat $lang/phones/sp.int $lang/phones/disambig.int > $lang/phones/tmp.disambig
	mv $lang/phones/tmp.disambig $lang/phones/disambig.int
fi
